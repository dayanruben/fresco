 ...
 * on screen.
 */
val actualImageDimensionsProvider: StringDebugDataProvider = StringDebugDataProvider(
    "I",
    "Image dimensions",
 ...
 */
val actualImageDimensionsWithPrefixProvider: StringDebugDataProvider = StringDebugDataProvider(
    "img",
    "Image dimensions",
 ...
 */
val scaleTypeProvider: StringDebugDataProvider = StringDebugDataProvider(
    "scale",
    "Scale Type",
 ...
 */
val abbreviatedScaleTypeProvider: StringDebugDataProvider = StringDebugDataProvider(
    "scale",
    "Scale Type",
...
val imageOriginWithExtrasProvider:
    StringAndColorDebugDataProvider = StringAndColorDebugDataProvider(
    "origin",
    "Origin",
